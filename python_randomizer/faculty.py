...
class Instructor:
    def __init__(self) -> None:
        ...
        self.id: int = random.randint(100_000, 999_999)
        self.dob: DOB = DOB()
        ...
        self.email: str = f"{self.firstName[0].lower()}{self.lastName.lower()}{EMAIL}"
        self.role: str = "FACULTY"
...
class DOB:
    def __init__(self) -> None:
        ...
        self.year: int = random.randint(1960, 1990)
